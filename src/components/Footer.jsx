      ...
      <div>
        <div className="row">
          <div className="col-2 text-start">
            ...
            {/*<Link to="/" alt="footer link" className="footer-links">               </Link>*/}
            ...
            <div className="d-flex">
              <div className="me-2 mt-2">
                <svg
                  ...
                  height="25"
                  fill="currentColor"
                  className="bi bi-question-circle-fill svg-footer"
                  viewBox="0 0 16 16"
                >
              ...
              <div>
                <Link to="/" alt="footer link" className="footer-links icons-link">
                  Domande?
                </Link>

                <p className="fw-light copyright">Visita il nostro Centro assistenza</p>
              </div>
            </div>
            <div className="d-flex">
              <div className="me-2 mt-2">
                <svg
                  ...
                  height="25"
                  fill="currentColor"
                  className="bi bi-gear-fill svg-footer"
                  viewBox="0 0 16 16"
                >
              ...
              <div>
                ...
                <p className="fw-light copyright">Vai alle impostazioni</p>
              </div>
            </div>
            <div className="d-flex">
              <div className="me-2 mt-2">
                <svg
                  ...
                  height="25"
                  fill="currentColor"
                  className="bi bi-shield-shaded svg-footer"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
              ...
              <div>
                ...
                <p className="fw-light copyright">Scopri di più sui contenuti consigliati.</p>
              </div>
            </div>
          </div>
